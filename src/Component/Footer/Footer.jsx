    ...
    return (
         ...
         <footer className="bg-gray-900 text-gray-300 py-10 px-6 md:px-20  overflow-x-hidden">
            ...
            <div className='flex justify-center mb-6'>
             ...
             <div className='flex flex-wrap justify-center contact-link  gap-10 text-center mb-6 lg:gap-12'>
                <a href="https://www.facebook.com/profile.php?id=61565204070045" target="_blank" rel="noopener noreferrer">Facebook</a>
      ...
      {/* <div className="flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="text-center md:text-left">
          <p className="text-lg font-semibold text-white">Joya Saha</p>
          <p className="text-sm">Creative Front End Architect</p>
        </div>

       
        <div className="flex gap-6 text-xl">
          <a href="mailto:joyasaha440@gmail.com" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-400 transition">
            <FaEnvelope />
          </a>
          <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-400 transition">
            <FaLinkedin />
          </a>
          <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-400 transition">
            <FaGithub />
          </a>
        </div>
