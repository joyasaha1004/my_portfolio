  ...
  <div className="max-w-screen-xl mx-auto text-gray-800 dark:text-gray-200 text-center lg:justify-self-center">
    ...
    <div className="flex flex-wrap gap-4 justify-center md:gap-7 ">
      {[
        ...
        <div
          key={i}
          className="flex flex-col items-center justify-center space-x-2 w-40 h-40 bg-gray-800 dark:bg-gray-800 text-white dark:text-gray-200 rounded-lg transition shadow-xl lg:w-52 lg:h-56"
        >
